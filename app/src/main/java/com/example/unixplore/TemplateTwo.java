...
public class TemplateTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    final AlertDialog.Builder builder = new AlertDialog.Builder(TemplateTwo.this);
                    ...
                    alertDialog.show();
                    //Toast.makeText(TemplateTwo.this, "Enter the pdf name", Toast.LENGTH_SHORT).show();
                }
                else
                    {
        ...
        mButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                try {
                    ...
                    if(fname.getText().toString().contentEquals(""))
                    {
                        Toast.makeText(TemplateTwo.this, "Enter the pdf name to be shared.", Toast.LENGTH_SHORT).show();
                    }
                    else
                        {
        ...
        protected String doInBackground(String... strings) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    {
                        Toast.makeText(TemplateTwo.this, "Enter valid email", Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                        return;
                    }
