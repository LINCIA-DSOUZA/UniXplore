...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    private void updateProfile(FirebaseUser firebaseUser) {
        ...
        if (TextUtils.isEmpty(textFullName)) {
            Toast.makeText(UpdateProfileActivity.this, "Enter your full name", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(UpdateProfileActivity.this, "Re-enter your mobile number", Toast.LENGTH_LONG).show();
            editTextUpdateMobile.setError("Mobile number entered is not valid");
            editTextUpdateMobile.requestFocus();
        } else {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menu_refresh){
            ...
            authProfile.signOut();
            Toast.makeText(UpdateProfileActivity.this, "You're now logged out", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(UpdateProfileActivity.this, FrontPage.class);
